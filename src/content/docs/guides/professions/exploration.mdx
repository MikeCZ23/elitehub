---
  title: Exploration
  description: Naučte sa objavovať nové systémy v Elite Dangerous.
---
...
Pro použití ho přiřadíme do námi zvolené fire group a použijeme stejně jako zbraň. Po použití odhalí všechny signály stelárních objektů v systému a jejich pozici. Tento proces skenování se nazývá **"Honk".**

![obr. 1 Správa po "honku"](@/assets/guides/professions/exploration/honk.jpg)
...
Před prvním použitím si musíme v nastavení ovládání hry nastavit ovládání FSS UI. Když otevřeme FSS UI, vidíme v info panelu počet detekovaných signálů a kolik z těchto signálů představuje planety a hvězdy. Zbylé signály jsou unidentified signal sources (USS).

![obr. 2 Interface FSS](@/assets/guides/professions/exploration/fss.jpg)
...
![obr. 3 Pomůcka pro diagram](@/assets/guides/professions/exploration/fss-diagram.jpg)
...
![obr. 4 Planeta po úspěšném skenu](@/assets/guides/professions/exploration/scanned-planet.jpg)
...
![obr. 5 Mapovací interface](@/assets/guides/professions/exploration/planet-mapping-interface.jpg)
...
Skenování i mapování nám dává finanční odměnu, která závisí na typu planety. Jak velkou odměnu za který druh planety dostaneme, najdeme ZDE. Pokud je planeta kandidátem na terraformování (terraformable), dostaneme za ni větší odměnu, než za ostatní stejného typu.
...
![obr. 6 Odměny za exploration](@/assets/guides/professions/exploration/rewards.jpg)
